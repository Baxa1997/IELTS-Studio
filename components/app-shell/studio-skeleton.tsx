      ...
      <div style={{ flex: 1, minHeight: 0, display: "flex" }}>
        ...
        >
          {Array.from({ length: 6 }).map((_, i) => (
            <div
              key={i}
              style={{ display: "flex", alignItems: "center", gap: 12, padding: "4px 6px" }}
            >
              <Block w={20} h={20} r={6} />
        ...
        <main
          style={{ flex: 1, minWidth: 0, overflow: "hidden", padding: "36px clamp(16px,4vw,40px)" }}
        >
...
export function StudioEditorSkeleton() {
  return (
    ...
    >
      ...
      <div
        className="lp-write-main"
        style={{ flex: 1, minHeight: 0, display: "flex", gap: 16, padding: 16 }}
      >
        ...
        <Panel
          style={{ flex: 1, minWidth: 0, padding: 0, display: "flex", flexDirection: "column" }}
        >
          <div
            style={{
              height: 60,
