...
import { AiGenerateSection } from "@/shared/components/ai-generate-section";
...
/**
 * A full-test card, built from the shared kit in shared/components/practice/card.tsx.
 *
 ...
 * the note at the top of shared/components/practice/card.tsx.
 */
function TestTile({
  seq,
  title,
