...
export function PublicGrader() {
  ...
  return (
    <div ref={rootRef} style={{ fontFamily: SANS, scrollMarginTop: 76 }}>
      ...
      <section style={{ background: PANEL, border: `1px solid ${LINE}`, borderRadius: 18, boxShadow: "0 20px 44px -32px rgba(26,33,56,.35)" }}>
          ...
          <div style={{ display: "flex", flexWrap: "wrap", alignItems: "center", gap: 7, marginTop: 10 }}>
            ...
            {question ? (
              <button
                type="button"
                onClick={() => setQuestion("")}
                style={{ height: 28, padding: "0 10px", borderRadius: 999, fontFamily: "inherit", fontSize: 12.5, fontWeight: 700, cursor: "pointer", border: "none", background: "transparent", color: SLATE_MUTED }}
              >
                Clear
              </button>
            ) : null}
        ...
        <textarea
          ...
          style={{ display: "block", width: "100%", resize: "vertical", minHeight: 300, border: "none", background: PANEL, padding: "20px 22px", fontFamily: SERIF, fontSize: 17, lineHeight: 1.9, color: SLATE_STRONG }}
        />
        ...
        <div style={{ position: "sticky", bottom: 0, zIndex: 5, display: "flex", flexWrap: "wrap", alignItems: "center", gap: 10, padding: "12px 16px", borderTop: `1px solid ${SOFT_LINE}`, background: "rgba(251,250,244,.94)", backdropFilter: "blur(6px)", WebkitBackdropFilter: "blur(6px)", borderRadius: "0 0 18px 18px" }}>
          ...
          <span style={{ fontSize: 12.5, fontWeight: 700, fontVariantNumeric: "tabular-nums", color: tooLong ? RED : tooShort ? AMBER : SLATE_MUTED }}>
          ...
          >
            {status === "grading" ? (
              <>
                <span className="animate-spin" style={{ width: 16, height: 16, borderRadius: "50%", border: "2.5px solid rgba(255,255,255,.35)", borderTopColor: PANEL, display: "inline-block" }} aria-hidden />
                Grading…
              </>
            ) : (
              "Grade my essay"
      ...
      <p style={{ margin: "12px 2px 0", fontSize: 12.5, color: SLATE_MUTED }}>
        {gradesLeft > 0
  ...
  return (
    ...
    >
      <div
        ...
        style={{ position: "relative", width: "100%", maxWidth: 440, background: PANEL, border: `1px solid ${LINE}`, borderRadius: 18, boxShadow: "0 40px 80px -30px rgba(26,33,56,.5)", padding: "30px 28px 26px", textAlign: "center" }}
      >
...
function Result({
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
      ...
      <div style={{ background: PANEL, border: `1px solid ${LINE}`, borderRadius: 16, padding: "16px 20px", display: "flex", alignItems: "center", gap: 22, flexWrap: "wrap" }}>
        <div style={{ flex: "none", display: "flex", alignItems: "center", gap: 14 }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 5 }}>
            <span style={{ fontSize: 12.5, fontWeight: 700, letterSpacing: ".04em", color: SLATE_MUTED, textTransform: "uppercase", lineHeight: 1.1 }}>
              Overall<br />band
            </span>
...
const labelCap: React.CSSProperties = { fontSize: 11.5, fontWeight: 700, letterSpacing: ".04em", color: SLATE_MUTED, textTransform: "uppercase" };
const detailP: React.CSSProperties = { margin: "4px 0 0", fontSize: 13.5, lineHeight: 1.5, color: SLATE_STRONG };
