...
/* ⚠️ THE COLOUR GOES IN `style`, NEVER IN THE `stroke`/`fill` ATTRIBUTE. These
   ...
   shared/components/practice/svg-vars.test.ts. */
...
function Flame({ c = WHITE, s = 14, filled = true }: { c?: string; s?: number; filled?: boolean }) {
  return (
    <svg
      ...
      height={s}
      viewBox="0 0 24 24"
      style={{ fill: filled ? c : "none", stroke: c }}
      strokeWidth="2"
      strokeLinecap="round"
      strokeLinejoin="round"
    >
  ...
  return (
    <span
      style={{
        background: st.bg,
        color: st.fg,
        border: `1px solid ${withAlpha(st.fg, 20)}`,
        borderRadius: 5,
        padding: "1px 5px",
        whiteSpace: "nowrap",
      }}
        ...
        >
          ...
          <div
            style={{
              ...
              gap: 8,
              padding: "7px 13px",
              background: "var(--tk-slate-green-bg)",
          ...
          >
            ...
            <span style={{ fontSize: 13.5, color: "var(--tk-slate-green)", fontWeight: 600 }}>
              Up to <strong style={{ fontWeight: 800, color: SLATE_GREEN }}>7.0</strong> with the
              fixes
            </span>
          </div>
        </div>
        <div style={{ flex: 1, display: "flex", gap: 12 }}>
          {tiles.map((t) => (
            <div
              ...
              style={{
                flex: 1,
                background: t.blk ? SLATE_RED_BG : SOFT,
                border: `1px solid ${t.blk ? BRAND_LINE : SOFTLINE}`,
                borderRadius: 12,
                padding: "11px 14px",
              }}
            >
              ...
              <div
                style={{
                  ...
                  height: 5,
                  borderRadius: 3,
                  background: t.blk ? SLATE_RED_BG : WARM_WELL,
                  overflow: "hidden",
                }}
              >
                <div
                  style={{
                    width: `${Math.round((t.band / 9) * 100)}%`,
                    height: "100%",
                    borderRadius: 3,
                    background: t.blk ? RED : t.color,
                  }}
                />
              </div>
              <div
                style={{
                  ...
                  fontSize: 11.5,
                  fontWeight: 600,
                  color: t.blk ? RED : t.color === AMBER ? AMBER : SLATE_MUTED,
                }}
              >
                {t.tag}
              </div>
      ...
      <div style={{ flex: 1, minHeight: 0, display: "flex", gap: 16, padding: 16 }}>
        ...
        >
          ...
          >
            <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
              <span style={{ fontSize: 16, fontWeight: 700, color: INK }}>
                Your essay, marked up
              </span>
              <span style={{ fontSize: 13, color: SLATE_MUTED }}>tap a highlight for the fix</span>
            </div>
            <div style={{ display: "flex", gap: 14 }}>
              {[
                ["Spelling", MARK.spelling, 1],
                ["Vocabulary", MARK.vocab, 1],
                ["Grammar", MARK.grammar, 1],
              ].map(([lbl, st, n]) => (
                <span key={lbl as string} style={{ display: "flex", alignItems: "center", gap: 6 }}>
                  <span
                    style={{
                      ...
                      height: 11,
                      borderRadius: 3,
                      background: (st as { bg: string }).bg,
                      border: `1px solid ${withAlpha((st as { fg: string }).fg, 33)}`,
                    }}
                  />
                  <span style={{ fontSize: 12.5, color: MUTED }}>
                    {lbl as string} <strong style={{ color: INK }}>{n as number}</strong>
                  </span>
                </span>
              ))}
            </div>
          ...
          <div style={{ flex: 1, padding: "30px 40px", overflow: "hidden" }}>
            ...
            >
              In recent decades, the number of people choosing to live alone has risen sharply.
              While some regard this as a sign of social breakdown, I believe it{" "}
              <Mk kind="vocab" n={1}>
                primarily reflects
              </Mk>{" "}
              greater{" "}
              <Mk kind="spelling" n={2}>
                independance
              </Mk>{" "}
              and should be seen as a positive development.
              {"\n\n"}
              Firstly, living alone allows individuals to develop essential life skills. When a
              person is solely responsible for cooking, budgeting and cleaning, they inevitably
              become more self-reliant. For example, a young graduate who rents their own flat must
              learn to manage money carefully, which{" "}
              <Mk kind="grammar" n={3}>
                builds a discipline that benefits them later in life
              </Mk>
              .
            </div>
            <p
        ...
        >
          <div
            style={{ flex: "none", padding: "14px 16px", borderBottom: `1px solid ${SOFTLINE}` }}
          >
            <div
              style={{ display: "flex", gap: 4, background: WELL, borderRadius: 11, padding: 4 }}
            >
              {["Bands", "Fixes · 3", "Insights", "Write it better"].map((t, i) => (
                <span
                  ...
                  style={{
                    ...
                    color: i === 0 ? INK : SLATE_MUTED,
                    boxShadow: i === 0 ? "0 1px 3px rgba(26,33,56,.14)" : "none",
                  }}
                >
                  {t}
                </span>
          ...
          <div style={{ flex: 1, padding: 16, overflow: "hidden" }}>
            ...
            >
              <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 9 }}>
                ...
                <span style={{ fontSize: 12, fontWeight: 800, letterSpacing: ".08em", color: RED }}>
                  FIX THIS FIRST
                </span>
                <span
                  style={{
              ...
              <p style={{ margin: 0, fontSize: 14, lineHeight: 1.55, color: SLATE_STRONG }}>
                <strong style={{ color: INK }}>Task Response</strong> — you state a clear position,
                but the counter-view is only mentioned, not developed. Give both sides equal,
                specific support to clear Band 7.
              </p>
            </div>
            <div
              style={{
            ...
            >
              ...
              <div style={{ marginBottom: 10 }}>
                ...
                >
                  You argue living alone builds independence with a clear graduate example, but
                  never address why others see it as “social breakdown”.
                </p>
              </div>
              <div
                style={{
              ...
              >
                <svg
                  ...
                  strokeLinecap="round"
                  strokeLinejoin="round"
                  style={{ stroke: INDIGO, flex: "none", marginTop: 1 }}
                >
                  <path d="M9 18h6M10 22h4M12 2a7 7 0 0 0-4 12.7c.6.5 1 1.3 1 2.1V18h6v-1.2c0-.8.4-1.6 1-2.1A7 7 0 0 0 12 2z" />
                </svg>
                <p style={{ margin: 0, fontSize: 13.5, lineHeight: 1.5, color: SLATE_INK }}>
                  <strong style={{ color: INDIGO }}>Fix:</strong> add one body paragraph that fairly
                  develops the opposing view, then rebut it — that balance is what separates Band 6
                  from Band 7.
                </p>
              </div>
            </div>
    ...
    >
      ...
      >
        <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
          ...
          <span style={{ width: 1, height: 24, background: LINE }} />
          <TaskPill>TASK 2</TaskPill>
          <span style={{ fontSize: 14, fontWeight: 500, color: SLATE_STRONG }}>
            Academic Writing
          </span>
          <span style={{ color: SLATE_MUTED }}>·</span>
      ...
      <div style={{ flex: 1, minHeight: 0, display: "flex", gap: 16, padding: 16 }}>
        ...
        >
          <div style={{ padding: "18px 20px 16px", borderBottom: `1px solid ${SOFTLINE}` }}>
            ...
            >
              Some people believe unpaid community service should be a compulsory part of
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 9 }}>
              ...
              >
                ...
                <div style={{ flex: 1 }}>
                  ...
                  >
                    <span style={{ fontSize: 14, fontWeight: 600, color: SLATE_INK }}>
        ...
        >
          ...
          >
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
              <span style={{ fontSize: 13, color: SLATE_MUTED, fontWeight: 500 }}>
                Target reached
              </span>
          ...
          <div style={{ flex: 1, minHeight: 0, padding: "26px 30px", overflow: "hidden" }}>
            ...
            >
              I strongly agree that a period of unpaid community service should be built into
              high-school education. Requiring young people to contribute to their communities
              develops empathy and practical skills that classroom study alone cannot provide.
              {"\n\n"}
              The most compelling argument is that community service exposes students to lives very
              different from their own. A teenager who spends a term helping at a care home, for
              instance, learns patience and responsibility while seeing first-hand the challenges
              older people face…
            </div>
          </div>
          <div
          ...
          >
            <span style={{ fontSize: 13, color: SLATE_MUTED, fontVariantNumeric: "tabular-nums" }}>
              <strong style={{ color: INK, fontWeight: 700 }}>{words}</strong> words
            </span>
            <span style={{ fontSize: 13, color: SLATE_MUTED, fontVariantNumeric: "tabular-nums" }}>
              1,432 characters
            </span>
        ...
        >
          ...
          >
            <span
              style={{
                ...
                height: 30,
                borderRadius: 9,
                background: "linear-gradient(135deg,#7d0132,#7d0132)",
                color: WHITE,
                display: "flex",
                alignItems: "center",
                justifyContent: "center",
          ...
          <div style={{ flex: 1, padding: 14, display: "flex", flexDirection: "column", gap: 10 }}>
            ...
            >
              Any better linking words for my second paragraph?
            </div>
            <div
              style={{
                alignSelf: "flex-start",
            ...
            >
              Try opening with <em>“The most compelling argument is…”</em>, then signpost the next
              idea with <em>“Beyond this,”</em> or <em>“A further benefit is that…”</em>. Vary them
              — repeating “also” caps Coherence.
            </div>
          </div>
    ...
    >
      ...
      >
        <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
          ...
          <span style={{ fontSize: 14.5, fontWeight: 600, color: INK }}>
            Academic Reading · Passage practice
          </span>
        </div>
        <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
          ...
          <span
            style={{
              ...
              fontWeight: 600,
              fontSize: 14,
              boxShadow: `0 4px 14px ${withAlpha(INDIGO, 28)}`,
            }}
          >
            Submit answers
          </span>
      ...
      <div style={{ flex: 1, display: "flex", minHeight: 0 }}>
          ...
          <div style={{ maxWidth: 620 }}>
            ...
            >
              <svg
                ...
                strokeLinejoin="round"
              >
                <path d="m9 11-6 6v3h3l6-6M13 7l4 4M18 2l4 4-9 9H9v-4l9-9Z" />
              </svg>
            ...
            <div style={{ lineHeight: 1.75, color: SLATE_INK, fontSize: 16 }}>
              For most of human history, cities were dense, walled and almost entirely paved. The
              idea that a metropolis should set aside large tracts of land purely for recreation
              would have struck a medieval planner as absurd — space inside the walls was far too
              valuable to leave unbuilt.
              {"\n\n"}
              The change came in the nineteenth century, as industrial cities swelled and their air
              grew thick with smoke. Reformers began to argue that access to greenery was not a
              luxury but a public-health necessity, and that a walk among trees could restore
              workers exhausted by the factory floor…
            </div>
          </div>
        </div>
        ...
        <div style={{ width: "44%", flex: "none", padding: "28px 40px", overflow: "hidden" }}>
          ...
          >
            <div style={{ fontSize: 13, fontWeight: 800, letterSpacing: ".04em", color: INDIGO }}>
              QUESTIONS 1–5
            </div>
            <p style={{ margin: "6px 0 0", fontSize: 14, lineHeight: 1.5, color: SLATE_STRONG }}>
              Do the following statements agree with the information in the passage? Choose{" "}
              <strong>TRUE</strong>, <strong>FALSE</strong> or <strong>NOT GIVEN</strong>.
            </p>
          </div>
          {[
            {
              n: 1,
              t: "Medieval cities commonly reserved land for public recreation.",
              pick: "FALSE",
            },
            {
              n: 2,
              t: "Nineteenth-century reformers linked green space to public health.",
              pick: "TRUE",
            },
            {
              n: 3,
              t: "The first public parks were funded entirely by private donors.",
              pick: null,
            },
          ].map((q) => (
              ...
              <div style={{ display: "flex", gap: 10 }}>
                <span
                  style={{
                    ...
                    height: 24,
                    borderRadius: 999,
                    border: `1.5px solid ${q.pick ? INDIGO : SP_LINE}`,
                    background: q.pick ? INDIGO : PANEL,
                    color: q.pick ? WHITE : SLATE_MUTED,
                    fontSize: 12.5,
                    fontWeight: 700,
                    display: "flex",
                    alignItems: "center",
                  ...
                  return (
                    <span
                      ...
                      style={{
                        ...
                        padding: "6px 12px",
                        borderRadius: 8,
                        border: `1.5px solid ${on ? INDIGO : SP_LINE}`,
                        background: on ? INDIGO_SOFT : PANEL,
                        color: on ? INDIGO : SLATE_MUTED,
                      }}
                    >
                      {o}
                    </span>
        ...
        {Array.from({ length: total }, (_, i) => i + 1).map((n) => {
            ...
            return (
              <span
                ...
                style={{
                  ...
                  background: PANEL,
                  color: INDIGO,
                  boxShadow: "0 0 0 3px rgba(79,70,229,.16)",
                }}
              >
                {n}
              </span>
          ...
          if (isAnswered)
            return (
              <span
                key={n}
                style={{ ...style, borderColor: INDIGO, background: INDIGO, color: WHITE }}
              >
                {n}
              </span>
            );
          return (
            <span
              key={n}
              style={{ ...style, borderColor: SP_LINE, background: PANEL, color: SLATE_MUTED }}
            >
              {n}
            </span>
          );
  ...
  const gap = (val?: string) => (
    <span
      style={{
        ...
        alignItems: "center",
        borderRadius: 8,
        border: `1.5px solid ${val ? V_BORDER : LINE}`,
        background: val ? V_SOFT : PANEL,
        color: val ? BRAND : "transparent",
        fontSize: 14.5,
        fontWeight: 600,
          ...
          return (
            <span
              ...
              style={{
                ...
                fontSize: 13.5,
                fontWeight: 600,
                border: `1px solid ${active ? V_BORDER : SOFTLINE}`,
                background: active ? V_BG : PANEL,
                color: active ? BRAND : SLATE_BODY,
              }}
            >
        ...
        <div style={{ maxWidth: 760, margin: "0 auto" }}>
          <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 4 }}>
            ...
            <span style={{ fontSize: 13, color: SLATE_MUTED }}>
              Complete the notes · Write <strong style={{ color: SLATE_INK }}>ONE WORD ONLY</strong>{" "}
              for each answer
            </span>
          </div>
          <h2
          ...
          <div style={{ marginTop: 10 }}>
            <div style={{ fontSize: 14, fontWeight: 600, color: SLATE_INK, padding: "14px 0 6px" }}>
              Facilities
            </div>
            {[
              {
                pre: "The main hall can be hired for ",
                val: "weddings",
                post: " and other private events.",
              },
              {
                pre: "A new ",
                val: undefined,
                post: " studio opens on the first floor in March.",
                n: true,
              },
            ].map((l, i) => (
              <div
            ...
            {[
              ...
              {
                pre: "Members receive a monthly ",
                val: undefined,
                post: " with the class timetable.",
                n: true,
              },
            ].map((l, i) => (
              <div
        ...
        <div style={{ display: "flex", gap: 16, marginTop: 24 }}>
          {[
            ...
            >
              ...
              >
                <div style={{ width: "70%", height: "100%", background: c as string }} />
              </div>
            </div>
          ))}
          <div
              ...
              {Array.from({ length: 7 }, (_, i) => (
                <span
                  ...
                  style={{
                    ...
                    height: 28,
                    borderRadius: 8,
                    background: i < 5 ? INDIGO : WELL,
                    border: `1.5px solid ${i < 5 ? INDIGO : SLATE_LINE}`,
                  }}
                />
              ))}
            </div>
      ...
      >
        <div
          style={{
            ...
            background: "linear-gradient(135deg,#F5F4FE,#EFEEFC)",
          }}
        >
          <div style={{ display: "flex", alignItems: "center", gap: 9 }}>
            ...
            <div>
              ...
              <div style={{ fontSize: 11.5, color: MUTED }}>
                Planning · strategy · what&rsquo;s next
              </div>
            </div>
          </div>
          <svg
        ...
        <div style={{ flex: 1, padding: 14, display: "flex", flexDirection: "column", gap: 10 }}>
          ...
          >
            Your Reading sits at <strong>6.5</strong> and Writing at <strong>6.0</strong>, so
            Writing is the gap to your 7.0 target. This week I&rsquo;d do{" "}
            <strong>two Task 2 essays</strong> focused on Task Response — that&rsquo;s your weakest
            criterion across your last 3 submissions. Want me to pick the prompts?
          </div>
  ...
  return (
    ...
    >
      ...
      <div style={{ display: "flex", alignItems: "flex-end", gap: 10, marginTop: 12 }}>
        ...
        <span style={{ fontWeight: 500, fontSize: 14, color: FAINT, paddingBottom: 6 }}>
      ...
      <div style={{ fontSize: 13, color: FAINT, marginTop: 10 }}>
        From {base.toFixed(1)} baseline{" "}
        <span style={{ color: EMERALD }}>· +{delta.toFixed(1)}</span> · 4 submissions
      </div>
    </div>
  );
}
...
function ProgressScreen() {
  return (
    ...
    >
      ...
      <div
        style={{ fontFamily: SERIF, fontWeight: 600, fontSize: 32, color: INK, margin: "6px 0 0" }}
      >
        Welcome back, Aziz
      </div>
      <div style={{ fontSize: 15, color: MUTED, margin: "6px 0 0" }}>
        Target Band 7.0 · <span style={{ color: INDIGO, fontWeight: 600 }}>24 days</span> to your
        test
      </div>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
          ...
          <div
            style={{
              position: "relative",
              overflow: "hidden",
              background: "linear-gradient(120deg,#241017 0%,#7d0132 62%,#7d0132 100%)",
              borderRadius: 18,
              padding: "24px 26px",
              display: "flex",
              alignItems: "center",
          ...
          >
            ...
            <div style={{ position: "relative", flex: "1 1 380px" }}>
              ...
              >
                <Spark s={13} /> Next task · picked for you
              </div>
              <div
                style={{
                  fontFamily: SERIF,
              ...
              >
                Task Response is your weakest criterion. A focused opinion essay is the fastest way
                to close the gap to Band 7.
              </p>
              <span
                style={{
                  display: "inline-flex",
                  ...
                  borderRadius: 11,
                  marginTop: 18,
                  boxShadow: "0 14px 30px -14px rgba(0,0,0,.55)",
                }}
              >
                Start writing <Arrow c={INK} />
              </span>
            </div>
            <div
              style={{
              ...
              {[
                ...
                <div
                  ...
                  style={{
                    ...
                    gap: 14,
                    padding: "13px 18px",
                    borderTop: i === 0 ? "none" : `1px solid ${SLATE_LINE}`,
                  }}
                >
                  ...
                  <span style={{ display: "flex", alignItems: "center", gap: 12 }}>
                    <span
                      style={{
                        ...
                        padding: "3px 9px",
                        borderRadius: 999,
                        color: h.up == null ? FAINT : EMERALD,
                        background: h.up == null ? WELL : SLATE_GREEN_BG,
                      }}
                    >
                      {h.delta}
                    </span>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
          ...
          >
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
              ...
              <span style={{ display: "inline-flex", alignItems: "center", gap: 6, color: AMBER }}>
                <Flame c={AMBER} s={17} />
            ...
            <div
              style={{ display: "flex", justifyContent: "space-between", gap: 6, marginTop: 13 }}
            >
                ...
                >
                  <span
                    style={{
                      ...
                      justifyContent: "center",
                      background: i < 5 ? INDIGO : WELL,
                      border: `1.5px solid ${i === 4 ? INDIGO : i < 5 ? INDIGO : SLATE_LINE}`,
                    }}
                  >
                    <Flame c={i < 5 ? WHITE : SLATE_MUTED} filled={i < 5} s={14} />
                  </span>
                  <span
                    style={{ fontSize: 10.5, fontWeight: 700, color: i === 4 ? INDIGO : FAINT }}
                  >
                    {d}
                  </span>
                </div>
            ...
            >
              <div
                style={{ width: "60%", height: "100%", background: INDIGO, borderRadius: 999 }}
              />
            </div>
            <p style={{ fontSize: 12.5, color: MUTED, margin: "10px 0 0" }}>
              2 more to go — keep the streak alive.
            </p>
          </div>
          ...
          >
            ...
            <div style={{ marginTop: 12 }}>
              ...
              <div style={{ fontWeight: 700, fontSize: 14.5, color: INK, marginTop: 1 }}>
                Task Response
              </div>
...
// A replica of the real exam room (app/(studio)/speak/exam/_components/live-mock.tsx) at the
    ...
    >
      ...
      <div
        style={{
          flex: "none",
          height: 54,
          borderBottom: `1px solid ${SP_LINE}`,
          background: PANEL,
          display: "flex",
          alignItems: "center",
          justifyContent: "space-between",
      ...
      >
        ...
        >
          <span>08:24</span>
          <span style={{ color: SLATE_FIELD }}>/</span>
          <span>16:00</span>
        </div>
      </div>
      {/* whole-test progress */}
          ...
          return (
            <div
              ...
              style={{
                ...
                letterSpacing: ".12em",
                textTransform: "uppercase",
                color: active ? BRAND : done ? SLATE_GREEN : SLATE_MUTED,
              }}
            >
              <span
                style={{
                  ...
                  display: "grid",
                  placeItems: "center",
                  background: active ? BRAND_FILL : done ? SLATE_GREEN_BG : WARM_WELL,
                  color: active ? WHITE : done ? SLATE_GREEN : SLATE_MUTED,
                  fontSize: 10.5,
                }}
              >
                {done ? "✓" : p.n}
      ...
      >
        ...
        >
          <div
            style={{
              ...
              inset: -14,
              borderRadius: "50%",
              border: "1px solid rgba(26,21,32,0.16)",
            }}
          />
          <div
            style={{
        ...
        <div style={{ display: "flex", alignItems: "flex-end", gap: 4, height: 26, marginTop: 16 }}>
          {[10, 18, 26, 15, 22, 12, 20, 9, 16, 24, 13, 19].map((h, i) => (
            <span
              key={i}
              style={{ width: 3.5, height: h, borderRadius: 2, background: SP_INK, opacity: 0.55 }}
            />
          ))}
        </div>
        <div
        ...
        <div
          style={{
            ...
            boxShadow: "0 14px 34px -20px rgba(26,21,32,.4)",
          }}
        >
          <span
            style={{
          ...
          <div style={{ fontSize: 12.5, fontWeight: 600, color: SP_FAINT, margin: "12px 0 4px" }}>
            You should say:
          </div>
          <ul
            style={{
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Up to <strong style={{ color: SLATE_GREEN }}>7.0</strong> with fixes
        </span>
      </div>
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12, marginTop: 18 }}>
        {[
          ["Task Response", "6.0", true],
          ["Coherence", "6.5", false],
          ["Lexical Resource", "6.0", false],
          ["Grammar", "7.0", false],
        ].map(([l, b, blk]) => (
          <div
            key={l as string}
            style={{
              background: blk ? SLATE_RED_BG : SOFT,
              border: `1px solid ${blk ? BRAND_LINE : SOFTLINE}`,
              borderRadius: 12,
              padding: "13px 16px",
              display: "flex",
              alignItems: "center",
      ...
      <div style={{ marginTop: 18, display: "flex", alignItems: "center", gap: 8 }}>
        <span style={{ fontSize: 12.5, fontWeight: 800, letterSpacing: ".06em", color: RED }}>
          FIX THIS FIRST
        </span>
        <span style={{ fontSize: 14, color: SLATE_STRONG }}>
          Task Response — develop the opposing view, don&rsquo;t just mention it.
        </span>
      </div>
    </div>
  );
  ...
  return (
    ...
    >
      ...
      >
        ...
        <span style={{ marginLeft: "auto", fontSize: 15, color: MUTED, paddingBottom: 6 }}>
          <strong style={{ color: INK }}>9/13</strong> correct · 69%
        </span>
      </div>
      <div style={{ marginTop: 16 }}>
        ...
        {[
          ["True / False / Not Given", "2 / 5", true],
          ["Matching headings", "3 / 4", false],
          ["Sentence completion", "4 / 4", false],
        ].map(([t, s, weak]) => (
          <div
            key={t as string}
            style={{
              ...
              padding: "10px 14px",
              borderRadius: 10,
              background: weak ? SLATE_RED_BG : SOFT,
              border: `1px solid ${weak ? BRAND_LINE : SOFTLINE}`,
              marginBottom: 8,
            }}
          >
            <span style={{ fontSize: 14, fontWeight: 600, color: weak ? RED : SLATE_INK }}>
              {t as string}
            </span>
            <span
              style={{
      ...
      <div style={{ marginTop: 12, fontSize: 13, color: MUTED, display: "flex", gap: 7 }}>
        ...
        <span>
          the passage says parks were “argued for”, not built — that&rsquo;s NOT GIVEN, not TRUE.
        </span>
      </div>
    </div>
  );
  ...
  return (
    ...
    >
      ...
      >
        ...
        <span style={{ marginLeft: "auto", fontSize: 15, color: MUTED, paddingBottom: 6 }}>
          <strong style={{ color: INK }}>26/40</strong> correct
        </span>
      </div>
      <div
        style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr 1fr", gap: 10, marginTop: 16 }}
      >
        {[
          ["Part 1", "8/10"],
          ["Part 2", "7/10"],
      ...
      >
        <div style={{ fontSize: 12.5, fontWeight: 700, color: BRAND, marginBottom: 4 }}>
          Q31 · you wrote “Tuesday”, answer was “Thursday”
        </div>
        <div style={{ fontSize: 13, color: MUTED, lineHeight: 1.5 }}>
          The speaker corrects herself — “…on Tuesday, sorry, I mean Thursday.” The transcript link
          jumps you to the exact line.
        </div>
      </div>
    </div>
  );
...
export const REPORT_CARDS: ReportCard[] = [
  {
    slug: "report-writing",
    caption:
      "A Task 2 essay report — per-criterion bands with evidence from the essay and the one fix that moves the score.",
  },
  {
    slug: "report-reading",
