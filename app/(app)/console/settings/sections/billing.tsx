...
/**
 * Billing & plan: the platform plan and what the center has used this month.
 * Center admin only — the settings route refuses it to anyone else.
 */
export async function BillingSection({ profile }: { profile: Profile }) {
