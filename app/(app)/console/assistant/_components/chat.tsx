...
import { liveProposalTurn } from "../_lib/live-proposal";
import { TelegramStaffPanel } from "../../_components/telegram-staff-panel";
  ...
  return (
    ...
    >
      ...
      >
        ...
        <span style={{ marginLeft: "auto", fontSize: 12, color: "#6f6a9e" }}>
          Nothing saved yet
        </span>
      </div>
