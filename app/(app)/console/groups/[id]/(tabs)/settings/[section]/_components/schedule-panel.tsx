...
import { type GroupFormState, setGroupSchedule } from "@/app/(app)/console/groups/actions";
import { type RoomChoice, ScheduleFields } from "@/app/(app)/console/_components/schedule-fields";
