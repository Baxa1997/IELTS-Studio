import { FAINT, INDIGO, INK, LINE, MUTED, SANS } from "@/shared/components/console/page-ui";
import { NEG_INK, POS_INK, TRACK } from "@/lib/theme/tokens";

/**
 * Charts for the platform console, drawn as plain SVG.
 *
 * No charting library: the app has never had one (see shared/components/writing/figure.tsx,
