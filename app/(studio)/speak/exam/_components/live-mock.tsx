...
import { checkMicAccess, type Mic, startMic, VoicePlayer } from "@/shared/components/speaking/audio";
import { ConfirmQuit } from "../../_components/confirm-quit";
...
import { LucidaScope, PERSONAS, personaById, WaveBars, mmss, type Persona } from "@/shared/components/speaking/lucida";
import { bearerProtocols, downgradeToQueryCarry, prefersSubprotocol } from "../../_lib/ws-auth";
