 ...
 * the pointer. That trap is recorded in shared/components/app-shell/nav-groups.test.ts
 ...
 * shared/components/app-shell/sidebar-nav.tsx and the guard in nav-groups.test.ts. */
