...
import {
  ...
  EngProgressLogo,
  EngProgressMark,
} from "@/shared/components/brand/engprogress-logo";
...
const MARK_BG = "#B8421E";
const MARK_FG = "#FFFFFF";
...
export function AppShell({
   ...
   * each admin page owns its own inset (see `Surface` in app/admin/_components/ui).
   ...
   * `Surface` (app/admin/_components/ui), and this is exactly where that broke
