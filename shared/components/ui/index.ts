 ...
 *
 *   import { Card, Badge, Stat, Modal, Field } from "@/shared/components/ui";
 *
 ...
 *
 * Staff screens have a richer kit in `@/app/(app)/console/_components/crm-ui` (tables, KPI
 * rows, meters, the rail) which reads from the same tokens. Exam screens have
 * `@/shared/components/exam`.
 */
